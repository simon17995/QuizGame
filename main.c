...
int main()
    ...
    system("cls");
     ...
     switch(r1)
		...
		if (toupper(getch())=='C')
			{
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is C.1954");
		           getch();
		       break;
		       }
		...
		printf("\n\nA.France\t\tB.Denmark\n\nC.Lake Superior\t\tD.Finland");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is C.Lake Superior");
		       getch();
		       break;}
...
void help()
    ...
    printf("\n    total 10 questions each right answer will be awarded 10000.");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
